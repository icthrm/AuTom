#ifndef SLIMAINWINDOW_H
#define SLIMAINWINDOW_H
#include <QMainWindow>

//#include "model/mrcdatamodel.h"
#include "ImageViewWindow/model/mrcdatamodel.h"
...
class SliceMainWindow : public QMainWindow
{
    Q_OBJECT
public:
    explicit SliceMainWindow(QWidget *parent = 0);
    void open(const QString& fileName);
    void openMark(const QString & fileName);
    bool eventFilter(QObject* watched, QEvent* event) override;
    ~SliceMainWindow() = default;
    static SliceMainWindow *ViewMrc(QString filepath);//add by hy
