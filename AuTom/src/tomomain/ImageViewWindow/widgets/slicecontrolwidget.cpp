	...
	, m_frontSlicePlayDirection(PlayDirection::Forward)
{
    ...
    m_topSlicePlayAction->setIcon(QIcon(":icons/play.png"));
    ...
    m_rightSlicePlayAction->setIcon(QIcon(":icons/play.png"));
    ...
    m_frontSlicePlayAction->setIcon(QIcon(":icons/play.png"));
    ...
    m_stopAction->setIcon(QIcon(":icons/pause.png"));
