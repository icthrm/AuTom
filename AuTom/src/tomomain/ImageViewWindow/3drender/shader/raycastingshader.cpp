...
{
    addShaderFromSourceFile(QOpenGLShader::Vertex, ":shaders/raycast_on_the_fly_gradient_v_glsl");
    addShaderFromSourceFile(QOpenGLShader::Fragment, ":shaders/raycast_on_the_fly_gradient_f.glsl");
	link();
}
...
{
    addShaderFromSourceFile(QOpenGLShader::Vertex, ":shaders/position_v.glsl");
    addShaderFromSourceFile(QOpenGLShader::Fragment, ":shaders/position_f.glsl");
	link();
}
...
SliceShader::SliceShader() {
    addShaderFromSourceFile(QOpenGLShader::Vertex, ":shaders/slice_shader_v.glsl");
    addShaderFromSourceFile(QOpenGLShader::Fragment, ":shaders/slice_shader_f.glsl");
	link();
}
