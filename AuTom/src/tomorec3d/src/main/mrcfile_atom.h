...
int mrc_read_slice_y(MPI_File fin, MrcHeader  *head, int slcN, char axis,float *mrc_data_slice);

int mrc_read_slice_floatseek(MPI_File fin, MrcHeader  *head, int slcN, char axis,float *mrc_data_slice);
int mrc_write_slice(MPI_File fout, MrcHeader  *head, int slcN,char axis,float *slcdata);
int mrc_read_slice_short(MPI_File fin, MrcHeader *head, int slcN, char axis,short *mrc_data_slice);
...
int mrc_write_pixel( MPI_File fout, MrcHeader  *head, int x, int y, int z ,float *pixel_gray);
