...
void display_usage()
{
	...
	printf(" example:\n");
	printf("	./cr_align caveolae060.st caveolae060.shift2.st caveolae060.rotation2.dat f_xyshift_glb1\n");
	exit(1);

}
void display_version()
{
	fprintf(stdout,"cr_align_xyshift Version: 1.0\n");
