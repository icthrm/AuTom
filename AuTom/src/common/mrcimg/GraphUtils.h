...
IplImage* drawFloatGraphWithXYLabel(const float *arraySrc, int nArrayLength, const char * xlabel, const char * ylabel, IplImage *imageDst DEFAULT(0), float minV DEFAULT(0.0), float maxV DEFAULT(0.0), int width DEFAULT(0), int height DEFAULT(0), char *graphLabel DEFAULT(0), bool showScale DEFAULT(true));
...
void showFloatGraphWithXYLabel(const char *name, const float *arraySrc, int nArrayLength, const char * xlabel, const char * ylabel, int delay_ms DEFAULT(500), IplImage *background DEFAULT(0));
