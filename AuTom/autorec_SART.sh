...
time mpiexec -n $threadnum ./tomorec3d -i auto_fin.mrc -t auto_new.tlt -g 0,0,0,$thickness -o auto_SART.mrc -m SART,10,0.2 -G $accelerate

echo "time mpiexec -n $threadnum ./tomorec3d -i auto_fin.mrc -t auto_new.tlt -g 0,0,0,$thickness -o auto_SART.mrc -m SART,10,0.2 -G $accelerate "
...
echo "complete, output file  is auto_SART.mrc"
