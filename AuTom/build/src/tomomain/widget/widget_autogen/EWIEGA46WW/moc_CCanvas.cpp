...
#include "../../../../../../src/tomomain/widget/CCanvas.h"
...
QT_MOC_LITERAL(1, 8, 11), // "sizeChanged"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 1), // "w"
QT_MOC_LITERAL(4, 23, 1) // "h"

    },
    "CCanvas\0sizeChanged\0\0w\0h"
};
...
void CCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CCanvas::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CCanvas::sizeChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject CCanvas::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CCanvas.data,
      qt_meta_data_CCanvas,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void CCanvas::sizeChanged(int _t1, int _t2)
{
