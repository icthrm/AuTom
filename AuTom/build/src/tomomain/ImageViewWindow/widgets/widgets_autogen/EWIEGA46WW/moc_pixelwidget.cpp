...
#include "../../../../../../../src/tomomain/ImageViewWindow/widgets/pixelwidget.h"
...
QT_MOC_LITERAL(1, 12, 11), // "setPosition"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 1) // "p"

    },
    "PixelWidget\0setPosition\0\0p"
};
...
void PixelWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setPosition((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject PixelWidget::staticMetaObject = {
    { &AbstractSliceViewPlugin::staticMetaObject, qt_meta_stringdata_PixelWidget.data,
      qt_meta_data_PixelWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PixelWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PixelWidget.stringdata0))
        return static_cast<void*>(const_cast< PixelWidget*>(this));
